const answear = new Object();
let countId = 7;
const addComents = () => {
  const commentsFace = document.querySelector(".newComments");
  const comment = document.createElement("div");
  comment.classList.add("comments");
  comment.style.display = "block";
  comment.id = "comment" + ++countId;
  let text = document.querySelector(".text").value;
  comment.innerHTML = `<div class="profile">
...
<small>
  <u>
    <font style="vertical-align: inherit">
      <font style="vertical-align: inherit"
        >1 minutos antes</font
      >
    </font>
  </u>
</small>
</div>`;
  commentsFace.append(comment);
  text.value = ``;
};
...
jQuery(document).ready(function () {
  ...
  $(document).ready(function () {
    $(".bq1").click(function () {
      answear.one = $(this).data("bq");
      $("#q1").fadeOut("slow", function () {
        $("#q2").fadeIn("slow");
      });
    }),
      $(".bq2").click(function () {
        answear.two = $(this).data("bq");
        $("#q2").fadeOut("slow", function () {
          $("#q3").fadeIn("slow");
        });
      }),
      $(".bq3").click(function () {
        answear.three = $(this).data("bq");
        $("#q3").fadeOut("slow", function () {
          $("#q4").fadeIn("slow");
        });
      }),
      $(".bq4").click(function () {
        answear.four = $(this).data("bq");
        scrollTo("id1"),
    ...
    _init: function () {
      setTimeout(function () {
        ...
        jQuery("#p_modal_button3").on("click", function (e) {
          ...
          console.log(Object.values(answear));
        });
    },
  }),
    jQuery(document).ready(function () {
